...
func (e *ExternalServiceList) GetMongoDB(ctx context.Context, cfg *config.Config) (mongo.MgoJobStore, error) {
...
func (e *Init) DoGetMongoDB(ctx context.Context, cfg *config.Config) (mongo.MgoJobStore, error) {
