...
func TestSetup(t *testing.T) {
	Convey("Given an API instance", t, func() {
		...
		Convey("When created the following routes should have been added", func() {
			...
			So(hasRoute(apiClient.Router, "/search-reindex-jobs/{id}/number_of_tasks/{count}", "PUT"), ShouldBeTrue)
		...
		Convey("And the following subroutes should have been added for version 1 of API", func() {
			...
			So(hasRoute(apiClient.Router, "/v1/search-reindex-jobs/{id}/number_of_tasks/{count}", "PUT"), ShouldBeTrue)
