...
func Setup(router *mux.Router,
	...
	v1.HandleFunc("/search-reindex-jobs/{job_id}/tasks/{task_name}/number-of-documents/{count}", permissions.Require(update, api.PutNumOfDocsHandler)).Methods("PUT")
...
func (api *API) v1RoutesAsLatest(permissions AuthHandler) {
	...
	api.Router.HandleFunc("/search-reindex-jobs/{job_id}/tasks/{task_name}/number-of-documents/{count}", permissions.Require(update, api.PutNumOfDocsHandler)).Methods("PUT")
