...
- PUT: http://localhost:25700/search-reindex-jobs/ID/number_of_tasks/10 (should put a value of 10 in the number_of_tasks field for the job with that particular id)
